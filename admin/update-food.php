            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        //remove image if new image is uploded
                        if($current_image!="")
                        {
                ...
                $sql3="UPDATE tbl_food SET
                 ...
                 if($res3==true)
                 {
                    $_SESSION="<div class='success'>Food Updated Successfully !</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                 }  
                 else
                 { 
                    $_SESSION="<div class='error'>Failed to update food.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                    
                 }  
                //redirect to managefood
            }
        ?>
    </div>
</div>
